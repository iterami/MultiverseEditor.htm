...
function repo_init(){
    core_repo_init({
      ...
      'storage-menu': '<table><tr><td>Camera/Character<br>'
          ...
          + '<input class=mini id=character-speed type=number>Speed<br>'
          + '<input id=character-collides type=checkbox><label for=character-collides>Collides</label>, Range<br>'
          + '<input class=mini id=character-collide-range-horizontal type=number>Horizontal<br>'
          + '<input class=mini id=character-collide-range-vertical type=number>Vertical<br>'
        ...
        + '<td>Multipliers<br>'
          ...
          + '<input class=mini id=multiplier-jump type=number>Jump<br>'
          + '<input class=mini id=jump-movement type=number>Jump Movement<br>'
          + '<input class=mini id=multiplier-speed type=number>Speed<br>'
          + '<input id=gravity-state type=checkbox><label for=gravity-state>Gravity Override</label><br>'
          + '<input class=mini id=gravity-acceleration type=number>Acceleration<br>'
          ...
          + '<input class=mini id=gravity-max type=number>Max<br>'
        ...
        + '<tr><td><input id=ambient-color type=color>Ambient Lighting<br>'
          ...
          + '<input class=mini id=directional-vector-x type=number>X<br>'
          + '<input class=mini id=directional-vector-y type=number>Y<br>'
          + '<input class=mini id=directional-vector-z type=number>Z'
        + '<td><select id=draw-type><option value="">Use Entity Properties</option><option value=LINES>Lines</option><option value=LINE_LOOP>Line Loop</option><option value=LINE_STRIP>Line Strip</option><option value=POINTS>Points</option><option value=TRIANGLES>Triangles</option><option value=TRIANGLE_FAN>Triangle Fan</option><option value=TRIANGLE_STRIP>Triangle Strip</option></select>Draw Type<br>'
          ...
          + '<input class=mini id=fog-density type=number>Fog<br>'
